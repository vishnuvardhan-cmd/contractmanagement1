  ...
  margin-left:50px;
    ...
    <form action="suppform" method="post" />
       <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
            <center><tr><td><h1><font color="azure">Supplier Registration Form</font></h1></td></tr><center>
        ...
        <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
            ...
            <tr>
                ...
                <td><input type="text" name="contactnumber" id="contactnumber" placeholder="Enter your Mobile No" pattern="[987]{1}[0-9]{9}" required></td>
            </tr>
            <tr> <td>&nbsp;</td> </tr>
            <tr>  
            ...
            <tr> <td>&nbsp;</td> </tr>
                ...
                <td>&nbsp;</td>
                <tr>
                    <td align='center'><a href="supplogin"><font color="azure">sign in</font></a></td>
                </tr>
        </table>
</form>  
        <center><h1><font color="azure">${msg}</font></h1> </body></center>
