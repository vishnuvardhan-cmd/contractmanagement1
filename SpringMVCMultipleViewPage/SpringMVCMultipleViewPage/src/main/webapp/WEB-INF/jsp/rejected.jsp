...
<body>
<center><h1><font color="azure">Rejection Page</font></h1></center>
<center>
<form action="rejecteddata" method="post">
<label> <font color="azure">Requirement Id: </font></label><input type="text" name="requirementid" required/><br>
<br>
<input type="submit"/>
</form>
</center>
